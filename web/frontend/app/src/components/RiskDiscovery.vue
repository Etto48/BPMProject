...
<template>
    <div class="risk-discovery-container">
        <div class="risk-log">
            <div class="card opportunity-log">
                <h2 class="capsule">Opportunities</h2>
            </div>
            <div class="card threat-log">
                <h2 class="capsule">Threats</h2>
            </div>
        </div>
        <RiskPreview :risk_kind="RiskKind.Opportunity"/>
    </div>
